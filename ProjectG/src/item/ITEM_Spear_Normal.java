...
public class ITEM_Spear_Normal extends Entity {
    public ITEM_Spear_Normal(GamePanel gp) {
        ...
        //Attack animations
        attackUp1 = setup("/player/attack_spear_up_1");
        attackUp2 = setup("/player/attack_spear_up_2");
        attackDown1 = setup("/player/attack_spear_down_1");
        attackDown2 = setup("/player/attack_spear_down_2");
        attackLeft1 = setup("/player/attack_spear_left_1");
        attackLeft2 = setup("/player/attack_spear_left_2");
        attackRight1 = setup("/player/attack_spear_right_1");
        attackRight2 = setup("/player/attack_spear_right_2");
